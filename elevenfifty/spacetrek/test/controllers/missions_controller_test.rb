...
class MissionsControllerTest < ActionController::TestCase
  ...
  test "should create mission" do
    assert_difference('Mission.count') do
      post :create, mission: { boxinfo: @mission.boxinfo, boxtitle: @mission.boxtitle, subtitle: @mission.subtitle, title: @mission.title }
    end
  ...
  test "should update mission" do
    patch :update, id: @mission, mission: { boxinfo: @mission.boxinfo, boxtitle: @mission.boxtitle, subtitle: @mission.subtitle, title: @mission.title }
    assert_redirected_to mission_path(assigns(:mission))
  end
